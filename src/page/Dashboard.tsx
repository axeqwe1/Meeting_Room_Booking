...
const Dashboard: React.FC = () => {
  ...
  const handleSelectSlot = (
    ...
    if (endDateOnly > startDateOnly) {
      ...
      endDay.setUTCHours(23, 59, 0, 0); // ตั้งเวลา 23:59 ของวัน end ที่เลือก
    ...
    <>
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-4">
          ...
          <div
            className={`${
              showRoomList && !defaultRoom ? "hidden" : "block"
            } lg:block lg:flex-1 h-[calc(100vh-12rem)] lg:h-auto`}
          >
            <CalendarView
              events={selectData}
              onClear={clearData}
          ...
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom sm:align-middle sm:max-w-lg sm:w-full w-full max-w-md my-8 overflow-hidden text-left transform transition-all">
              <EventDetails
                ...
                room={
                  allRooms.find((r) => r.id === selectedBooking.roomId) ||
                  allRooms[0]
                }
